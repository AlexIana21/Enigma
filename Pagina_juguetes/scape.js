...
function validarRespuestaPrueba2() {
  ...
  function validarRespuestaPrueba3() {
    ...
    if (respuesta.trim() === "respuesta_correcta_prueba_3") {
      document.getElementById("prueba3").classList.add("prueba-oculta");
...
function validarRespuestaPrueba4() {
    ...
    if (respuesta === "ipv4") {
        document.getElementById("feedbackPrueba4").innerHTML = "¡Respuesta correcta!";
...
function validarRespuestaPrueba5() {
    ...
    if (respuesta === "cesar") {
        document.getElementById("feedbackPrueba5").innerHTML = "¡Respuesta correcta!";
...
function validarRespuestaPrueba6() {
    ...
    if (respuesta === "disco duro" || respuesta === "disco duro sólido") {
        document.getElementById("feedbackPrueba6").innerHTML = "¡Respuesta correcta!";
...
function validarRespuestaPrueba7() {
    ...
    if (respuesta.trim() === "respuesta_correcta_prueba_7") {
